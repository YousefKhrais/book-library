            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="{{route('user.publisher.index')}}">Publishers<span class="lnr lnr-arrow-right"></span></a>
                        <a href="{{url('/publisher/show/'.$selected_publisher->id) }}">{{$selected_publisher->name}}</a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                        ...
                        @foreach ($publishers as $publisher)
                            <li class="main-nav-list">
                                <a href="{{url('/publisher/show/'.$publisher->id) }}"
                                   @if($publisher->id == $selected_publisher->id)
                                   style="color: #ffba00"
                                    @endif
                                >
            ...
            <div class="col-xl-9 col-lg-8 col-md-7">
                ...
                <section class="lattest-product-area pb-40 category-list">
                    <div class="row">
                        @foreach ($selected_publisher->books as $book)
