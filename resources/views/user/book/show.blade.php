            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="{{route('user.book.index')}}">Books<span class="lnr lnr-arrow-right"></span></a>
                        <a href="{{url('/book/show/'.$book->id) }}">{{$book->name}}</a>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="row s_product_inner">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            <li>
                                <a class="active" href="{{url('/author/show/'.$book->author->id) }}">
                                    <span>Author</span>
                                    : {{$book->author->name}}
                                </a>
                            </li>
                            <li>
                                <a class="active"
                                   href="{{url('/category/show/'.$book->category->id) }}">
                                    <span>Category</span>
                                    : {{$book->category->name}}
                                </a>
                            </li>
                            <li>
                                <a class="active" href="{{url('/publisher/show/'.$book->publisher->id) }}">
                                    <span>Publisher</span>
                                    : {{$book->publisher->name}}
                                </a>
                            </li>
